...
export default class Dashboard extends Component {
  ...
  removeBusinesses = () => {
    ...
    if (currentBusinesses.length === 0) {
      params['page'] -= 1;
      if (params['page'] > 0) this.setParams(params);
    }
    this.encodeQueryData();
  };
  ...
  render = () => {
    ...
    let prev = prev_page ? (
      <li className="page-item">
        <a className="page-link" id="prev" onClick={() => this.handleSetPage(prev_page)} href="#">
          Previous
        </a>
      </li>
    ) : (
      <li className="page-item disabled">
        <span className="page-link off">Previous</span>
      </li>
    );

    let next = next_page ? (
      <li className="page-item">
        <a onClick={() => this.handleSetPage(next_page)} id="next" className="page-link" href="#">
          Next
        </a>
      </li>
    ) : (
      <li className="page-item disabled">
        <span className="page-link off">Next</span>
      </li>
    );
          ...
          <div className="row">
            <div className="col">
              <div className="call-action">
                <div className="text">
                  <h3>
                    You currently have {this.state.businessWrap.total === 0 && 'no'}
                    {this.state.businessWrap.businesses.length > 0 &&
                      this.state.businessWrap.total}{' '}
                    businesses registered
                  </h3>
                  <p>
                    Sieze this opportunity to add your business on our platform to get access to
            ...
            <div className="col">
              ...
              <nav aria-label="Page navigation example">
                <ul className="pagination justify-content-end">
                  <li className="page-item disabled">
                    <span className="page-link">Per page:</span>
                  </li>
                  <li className="page-item">
                    <select
                      value={this.state.params.limit}
                      id="limit"
                  ...
                  <li className="page-item active">
                    <span className="page-link">{curr}</span>
                  </li>
                  {next}
                </ul>
              </nav>
